...
import com.liferay.jndi.example.exception.NoSuchFooException;
...
import com.liferay.jndi.example.service.persistence.FooPersistence;
import com.liferay.jndi.example.service.persistence.FooUtil;
import com.liferay.jndi.example.service.persistence.impl.constants.EXTPersistenceConstants;
...
public class FooPersistenceImpl
	...
	@Override
	@Reference(
		target = EXTPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = EXTPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
