...
package com.liferay.jndi.example.service.persistence.test;

import com.liferay.arquillian.extension.junit.bridge.junit.Arquillian;
import com.liferay.jndi.example.exception.NoSuchFooException;
import com.liferay.jndi.example.model.Foo;
import com.liferay.jndi.example.service.FooLocalServiceUtil;
...
public class FooPersistenceTest {
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "com.liferay.jndi.example.service"));
	...
	protected OrderByComparator<Foo> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"EXT_Foo", "uuid", true, "fooId", true, "groupId", true,
